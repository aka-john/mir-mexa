...
switch ($input['mode']) {
	case '87' : // new user
        ...
        $field = compact('internalKey','fullname','role','email','phone','mobilephone','fax','zip','street','city','state','country','gender','dob','photo','comment','blocked','blockeduntil','blockedafter','birthday');
...
?>
	...
	case '88' : // edit user
		...
		$field = compact('fullname','role','email','phone','mobilephone','fax','zip','street','city','state','country','gender','dob','photo','comment','failedlogincount','blocked','blockeduntil','blockedafter','birthday');
		$field = $modx->db->escape($field);

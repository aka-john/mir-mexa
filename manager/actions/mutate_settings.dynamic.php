	...
	<!-- Site Settings -->
      <div class="tab-page" id="tabPage2">
        ...
        <table border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td nowrap="" class="warning"><b>Лимит отправки smtp</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="smtp_limit" value="<?php echo isset($smtp_limit) ? htmlspecialchars($smtp_limit) : "" ; ?>"></td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>LiqPay сигнатура</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="liqpay_sign" value="<?php echo isset($liqpay_sign) ? htmlspecialchars($liqpay_sign) : "" ; ?>"></td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>LiqPay мерчант</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="liqpay_merchant" value="<?php echo isset($liqpay_merchant) ? htmlspecialchars($liqpay_merchant) : "" ; ?>"></td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>reCaptcha public key</b></td>
                <td>
                    <input type="text" name="reCaptcha_public" placeholder="" style="width:300px" value="<?php echo isset($reCaptcha_public) ? htmlspecialchars($reCaptcha_public) : "" ; ?>"> 
                    &nbsp;<a href="https://www.google.com/recaptcha/" target="_blank">get these keys</a>
                </td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>reCaptcha private key</b></td>
                <td>
                    <input type="text" name="reCaptcha_private" placeholder="" style="width:300px" value="<?php echo isset($reCaptcha_private) ? htmlspecialchars($reCaptcha_private) : "" ; ?>"> 
                </td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>Стоимость доставки</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="delivery_price" value="<?php echo isset($delivery_price) ? htmlspecialchars($delivery_price) : "" ; ?>"></td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>Бесплатная доставка от</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="free_delivery" value="<?php echo isset($free_delivery) ? htmlspecialchars($free_delivery) : "" ; ?>"></td>
            </tr>
            <tr>
                <td colspan="2"><div class='split'></div></td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>siteHeart</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="site_heart" value="<?php echo isset($site_heart) ? htmlspecialchars($site_heart) : "" ; ?>"></td>
            </tr>
            <tr>
                <td colspan="2"><div class='split'></div></td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Телефоны</b></td>
                <td>
                    <textarea name="head_phone" value="<?php echo isset($head_phone) ? htmlspecialchars($head_phone) : "" ; ?>"><?php echo isset($head_phone) ? htmlspecialchars($head_phone) : "" ; ?></textarea>
                </td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Телефоны в футере</b></td>
                <td>
                    <textarea name="footer_phone" value="<?php echo isset($footer_phone) ? htmlspecialchars($footer_phone) : "" ; ?>"><?php echo isset($footer_phone) ? htmlspecialchars($footer_phone) : "" ; ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2"><div class='split'></div></td>
            ...
            <tr>
              <td nowrap="" class="warning"><b>Телефон в письме 1</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="mail_phone_1" value="<?php echo isset($mail_phone_1) ? htmlspecialchars($mail_phone_1) : "" ; ?>"></td>
            </tr>
            <tr>
              <td nowrap="" class="warning"><b>Телефон в письме 2</b></td>
              <td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 200px;" name="mail_phone_2" value="<?php echo isset($mail_phone_2) ? htmlspecialchars($mail_phone_2) : "" ; ?>"></td>
            </tr>
            <tr>
                <td colspan="2"><div class='split'></div></td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Ссылка Vk</b></td>
                <td>
                    <input type="text" name="vk_link" placeholder="" style="width:300px" value="<?php echo isset($vk_link) ? htmlspecialchars($vk_link) : "" ; ?>"> 
                </td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Ссылка Facebook</b></td>
                <td>
                    <input type="text" name="facebook_link" placeholder="" style="width:300px" value="<?php echo isset($facebook_link) ? htmlspecialchars($facebook_link) : "" ; ?>"> 
                </td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Ссылка Tweeter</b></td>
                <td>
                    <input type="text" name="tweet_link" placeholder="" style="width:300px" value="<?php echo isset($tweet_link) ? htmlspecialchars($tweet_link) : "" ; ?>"> 
                </td>
            </tr>
            <tr>
                <td nowrap="" class="warning"><b>Группа Facebook</b></td>
                <td>
                    <input type="text" name="facebook_group" placeholder="" style="width:300px" value="<?php echo isset($facebook_group) ? htmlspecialchars($facebook_group) : "" ; ?>"> 
                </td>
            </tr>
            <tr>
              <td colspan="2"><div class='split'></div></td>

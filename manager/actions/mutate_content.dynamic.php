...
<div class="tab-pane" id="documentPane">
    ...
    <div class="tab-page" id="tabGeneral">
        ...
        <table width="99%" border="0" cellspacing="5" cellpadding="0">
            <?php if ($content['template'] == 7) {?>
                <tr style="height: 24px;">
                    <td width="100" align="left">
                        <span class="warning">Переход к товарам</span>
                    </td>
                    <td>
                        <a href="index.php?a=112&id=2&controller=product&action=index&filter[category]=<?php echo $modx->htmlspecialchars(stripslashes($content['id']))?>" class="primary">Перейти к товарам категории "<?php echo $modx->htmlspecialchars(stripslashes($content['pagetitle'.($modx->config['lang_enable'] ? "_".$lng : "")]))?>"</a>
                    </td>
                </tr>
            <?php } ?>
